...
contract Fundraising2 {
    ...
    function drawback() public {
        require((isCancel)||(now > endTime && money < target));
        require(p_money[msg.sender] > 0);
        
        msg.sender.transfer(p_money[msg.sender]);
        restMoney = restMoney - p_money[msg.sender];
        p_money[msg.sender] = 0;
    }
